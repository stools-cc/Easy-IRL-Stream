...
static const HelpStrings LANG_DE = {
	...
	"Trage Subdomain + Token in den Plugin-Einstellungen unter <i>DuckDNS</i> ein",
	...
	"In OBS: <b>SRT</b> als Protokoll w&auml;hlen und <b>SRTLA aktivieren</b> "
	"(in den Source-Einstellungen unter <i>SRTLA</i>)",
...
static const HelpStrings LANG_EN = {
	...
	"Copy your <b>Token</b>",
	"Enter subdomain + token in the plugin settings under <i>DuckDNS</i>",
	...
	"In OBS: Select <b>SRT</b> as protocol and <b>enable SRTLA</b> "
	"(in the source settings under <i>SRTLA</i>)",
